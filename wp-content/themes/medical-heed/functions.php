...
if ( ! function_exists( 'medical_heed_setup' ) ) :
	...
	function medical_heed_setup() {
		...
		if ( is_admin() && ('themes.php' == $pagenow) && isset( $_GET['activated'] ) ) {
			add_action( 'admin_notices', 'medical_heed_activation_notice' );
		}
	}
endif;
...
function medical_heed_scripts() {
	...
	wp_enqueue_style( 'font-awesome', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'assets/library/font-awesome/css/fontawesome'. esc_attr ( $min ) . '.css' );
